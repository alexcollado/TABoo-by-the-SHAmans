...
class _SQLAlchemyState(object):
    """Remembers configuration for the (db, backend) tuple."""
...
class SQLAlchemy(object):
    ...
    def create_scoped_session(self, options=None):
        ...
        specify a custom scope function.  If it's not provided, Flask's backend
    ...
    def get_binds(self, app=None):
        ...
        This is suitable for use of sessionmaker(binds=db.get_binds(backend)).
        """
        app = self.get_app(app)
