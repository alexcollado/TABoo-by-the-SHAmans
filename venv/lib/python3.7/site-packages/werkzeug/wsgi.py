...
def extract_path_info(
    ...
    >>> extract_path_info(backendenbackendd/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/backend',
    ...                   'https://example.com/backend/hello')
    u'/hello'
    >>> extract_path_info('http://example.com/backend',
    ...                   'https://example.com/backend/hello',
...
class ClosingIterator(object):
    ...
    that::
        ...
        return ClosingIterator(backend(environ, start_response), [cleanup_session,
                                                              cleanup_locals])
